...
switch ($data['identifier']){
	...
	$section_identifier['output'] = $doctor_data;	
	
	break;
	
	case 'location_data':
	$section_identifier['status'] = true;
	$section_identifier['output'] = $location_data;	
	
	break;	
	
	case 'callout_data':
	$section_identifier['status'] = true;
	$section_identifier['output'] = $callout_data;	
	
	break;	
	
	case 'social_data':
	$section_identifier['status'] = true;
	$section_identifier['output'] = $social_data;	
	
	break;	
	
	case 'page_data':
	$section_identifier['status'] = true;
	$section_identifier['output'] = $page_data;	
